...
Vox2 = pd.read_csv("data/voxceleb2_dev_fixed.csv")
print(Vox2.head())
...
Vox2_0.to_csv("data/voxceleb2_dev_fixed_half1.csv", index = False)
Vox2_1.to_csv("data/voxceleb2_dev_fixed_half2.csv", index = False)
