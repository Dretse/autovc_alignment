...
Vox1 = pd.read_csv("data/voxceleb1_dev_half"+str(half)+".csv")
Vox2 = pd.read_csv("data/voxceleb2_dev_fixed_half"+str(half)+".csv")
...
Vox.to_csv("data/voxceleb_dev_half"+str(half)+".csv", index = False)
